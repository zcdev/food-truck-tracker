        ...
        <header className="fixed z-5 max-w-full md:max-w-4xl md:flex bg-stone-800 border-b-1 border-yellow-100 w-full pt-4 px-8 md:px-0 pb-6">
            <div className="max-w-full">
                ...
                <div className="md:pt-4">
                    ...
                    <p className="text-xl md:text-2xl text-yellow-100 tracking-normal text-center md:text-left">Your next bite is on the <em className="tracking-widest font-bold text-orange-500">MOVE</em>.</p>
                </div>
            </div>
        </header>
    );
