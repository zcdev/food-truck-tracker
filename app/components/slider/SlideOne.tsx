...
export default function SlideOne({ nextTrucks }: Props) {
    ...
    return (
        <div className="slide slide-one bg-stone-800 mt-8 pl-0 md:pl-47 text-center md:text-right">
            ...
            <p className="text-center md:text-left text-yellow-100 italic">@{truckOne.truckName} → <br className="block md:hidden" /><strong>{truckOne.location}</strong> in <strong className="text-orange-500">10</strong> mins</p>
