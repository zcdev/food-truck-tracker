    ...
    return (
        <div className="slide slide-two-three flex flex-col-reverse md:flex-row bg-stone-800 pl-0 md:pl-47 text-center md:text-left place-content-start">
            <div className="content w-full md:w-[45%] mr-0 md:mr-5">
                <h1 className="text-center md:text-left text-3xl font-bold pt-2 md:pt-10">Featured Trucks</h1>
                ...
                <Link href="/#about" className="inline-block w-auto text-[17px] md:text-lg text-white font-bold bg-orange-700 rounded-lg hover:bg-orange-500 px-4 py-3 mt-4">Trucks</Link>
            </div>
